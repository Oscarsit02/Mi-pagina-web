...
const eventDate = new Date(2025, 10, 8, 21, 0, 0);
...
btnConfirmar.addEventListener('click', () => {
    const numero = "+595985939986"; // tu número con código de país
    const mensaje = "Hola Paola, confirmo mi asistencia Para tu boda";
